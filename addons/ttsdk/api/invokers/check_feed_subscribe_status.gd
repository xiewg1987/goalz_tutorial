extends TTAsyncTask
class_name TTAsyncCheckFeedSubscribeStatus
...
func invoke() -> void:
	...
	TTUtils.invoke_js_argv(_get_javascript_object(), 'checkFeedSubscribeStatus', args)
...
class SuccessRes0 extends TTObject:
	...
	var status: bool:
		get:
			return _get_by_key_with_default('status', false)
