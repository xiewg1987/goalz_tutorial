extends TTAsyncTask
class_name TTAsyncExitMiniProgram
...
var is_full_exit: bool:
	set(value):
		_args_object_set(0, 'isFullExit', value)
...
func invoke() -> void:
	...
	TTUtils.invoke_js_argv(_get_javascript_object(), 'exitMiniProgram', args)
